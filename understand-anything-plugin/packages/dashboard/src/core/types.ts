...
// Companion embeddings file (embeddings.json) — kept out of the graph JSON so
// it can be lazy-loaded only in semantic search mode. See arch_analysis.embeddings.
