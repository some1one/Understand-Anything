...
- `LANGUAGE_CONTEXT`: Concatenated language addenda loaded through `/understand-language`.
- `FRAMEWORK_CONTEXT`: Concatenated framework addenda loaded through `/understand-framework`.
